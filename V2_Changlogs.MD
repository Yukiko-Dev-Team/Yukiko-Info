...
-------------- NAVIGATION --------------  
Older Change logs:  
[2.0 -> 2.0.9](https://github.com/Yukiko-Dev-Team/Yukiko-Info/blob/master/Older_Changelogs/2.0.MD) | [2.1 -> 2.1.9](https://github.com/Yukiko-Dev-Team/Yukiko-Info/blob/master/V2_Changlogs.MD)  
...
## Version 2.2.2~Patch-1 (([Production](https://yukiko.app/release)) 
...
## Version 2.2.2~Patch-2 ([Canary](https://yukiko.app/release)) 
...
+ Add Permissions for `/kick` command
+ Add Permissions for `/ban` command
+ Add Permissions for `/timeout` command
