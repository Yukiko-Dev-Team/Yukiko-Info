...
## Version 2.2.21~Patch-1 ([Production](https://yukiko.app/release))
...
## Version 2.2.22~Patch-1 ([Canary](https://yukiko.app/release)) 
...
+ Fix Avatar XP bar (Thanks to [Azmerhors](https://github.com/azmerhos))
